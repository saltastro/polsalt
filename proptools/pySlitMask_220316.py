...
from ImageDisplay_ros import ImageDisplay
...
class SlitMaskGui(QtGui.QMainWindow, InfoTab, CatalogTab, OptimizeTab, SlitTab, RefTab, FinalizeTab):
    def __init__(self, parent=None, infile=None, inimage=None, center_ra=None, center_dec=None,     \
            position_angle=None, debug=False):
        ...
        #set up the slitmask
        self.slitmask=SlitMask(self.ui,center_ra=center_ra, center_dec=center_dec, position_angle=position_angle)
...
#        QtCore.QObject.connect(self.slitmask, SIGNAL('xmlloaded'), self.setcreator)
    ...
    def displayslits(self): 
        """Add the gaps, slits, spec footprint, fov to the image """       
    ...
    def loadimage(self, inimage=None):
        ...
        self.imagedisplay.ds9.set('cmap invert')
        self.imagedisplay.ds9.set('scale mode 99.5')
