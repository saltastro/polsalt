...
def calaccuracy_assess(infile, **kwargs):
  ...
  # compute calibration mean PA ripple accuracy from stokes cycle mean, rotated to pq,pu 
    ...
    if debug:
        ...
        np.savetxt(name+"_assessdebug.txt",np.vstack((ok_w,okfit_w,wav_w,dwav_w,pafit_w,stokes_Sw[0],runmedint_w,vstokes_vw,verr_vw)).T,  \
            fmt=" %2i %2i %6.1f %6.1f %8.3f  %10.3e %9.2e %8.3f %8.3f  %8.3f %8.3f")
