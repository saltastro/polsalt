...
def calaccuracy_assess(infile, **kwargs):
    ...
    debugfile = kwargs.pop('debugfile','')       
  ...
  # compute calibration mean PA ripple accuracy from stokes cycle mean, rotated to pq,pu 
    ...
    chi2dofacc_hs,meanacc_hs,varacc_hs,wavmean_h,wlen_h = chi2sample(stokesrot_sw,varrot_sw[:2],okfit_w,wav_w,dwav_w,debugfile=debugfile)
